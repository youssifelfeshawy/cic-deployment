...
# # CSV file path
# csv_file = '/tmp/pcap/output/flows.csv'

# # Check if the CSV exists initially
# if not os.path.exists(csv_file):
#     print(f"No CSV file found at {csv_file}. Exiting.")
#     sys.exit(1)

# print("Monitoring CSV file... Press Ctrl+C to stop.")
# last_len = 0
